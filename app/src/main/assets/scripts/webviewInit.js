  ...
  window.runtime = {
    ...
    callObjectC: function(js) {
      if (!this.ScriptFrameParent) {
        ...
        this.ScriptFrameParent.cssText =
          'position:absolute;left:0px;top:0;width:1px;height:1px;display:none';
    ...
    callConchJSFunction: function(name, json, callback) {
      this.callObjectC(
        'callConchJSFunction' + '\5' + name + '\5' + json + '\5' + callback
      );
    },
...
window.postRuntimeMessage = function(d, s) {
  window.runtime.callConchJSFunction(
    'window.postRuntimeMessage',
